# Purpose: To run a five region OM, with a five region EM "true values" (base recruitment w/ global ssb local b40)
...
saveRDS(sim_env_current, here("outputs", "mse_results", "spatial_no_block_scenarios", "five_region_global_ssb_local_b40.RDS"))
