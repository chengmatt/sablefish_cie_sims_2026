# Purpose: To run a five region OM, with a five region EM "true values" (base recruitment w/ global ssb local b40) run for 60 years
...
sim_env_current <- run_five_rg_closedloop_parallel(sim_env = sim_env_current, n_sims = n_sims,
                                                   ...
                                                   hcr_type = 'local_ssb_global_b40',
                                                   n_cores = 7)

saveRDS(sim_env_current, here("outputs", "mse_results", "spatial_noblock_scenarios", "five_region_local_ssb_global_b40.RDS"))
