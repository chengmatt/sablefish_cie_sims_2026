...
ggplot() +
  ...
  theme_bw(base_size = 13)
ggsave(file.path(fig_dir, 'ssb_regional.png'), width = 14, height = 4, dpi = 300)
...
ggplot() +
  ...
  ggthemes::scale_fill_colorblind() +
  labs(x = 'Year', y = 'SSB', fill = 'Model', color = 'Model')
ggsave(file.path(fig_dir, 'ssb_global.png'), width = 8, height = 5, dpi = 300)
...
ggplot() +
  ...
  theme_bw(base_size = 13)
ggsave(file.path(fig_dir, 'catch_regional.png'), width = 14, height = 4, dpi = 300)
...
ggplot() +
  ...
  ggthemes::scale_fill_colorblind() +
  labs(x = 'Year', y = 'Catch', fill = 'Model', color = 'Model')
ggsave(file.path(fig_dir, 'catch_global.png'), width = 8, height = 5, dpi = 300)
...
ggplot() +
  ...
  theme_bw(base_size = 13)
ggsave(file.path(fig_dir, 'rec_regional.png'), width = 14, height = 4, dpi = 300)
...
ggplot() +
  ...
  ggthemes::scale_fill_colorblind() +
  labs(x = 'Year', y = 'Recruitment', fill = 'Model', color = 'Model')
ggsave(file.path(fig_dir, 'rec_global.png'), width = 8, height = 5, dpi = 300)
...
ggplot() +
  ...
  theme_bw(base_size = 13)
ggsave(file.path(fig_dir, 'apportionment.png'), width = 14, height = 4, dpi = 300)

## Process Estimation Bias Results ------------------------------------------------
n_cl_yrs <- end_yr - st_yr + 1

ssb_est_results      <- totbiom_est_results <- rec_est_results <- array(NA, dim = c(3, n_cl_yrs, end_yr, n_sims))
ssb_true_results     <- totbiom_true_results <- rec_true_results <- array(NA, dim = c(3, end_yr, n_sims))
q_est_results        <- r0_est_results <- array(NA, dim = c(3, n_cl_yrs, n_sims))
q_true_results       <- r0_true_results <- array(NA, dim = c(3, n_sims))
ssb_bias_results     <- totbiom_bias_results <- rec_bias_results <- array(NA, dim = c(3, n_cl_yrs, end_yr, n_sims))
...
ggsave(file.path(fig_dir, 'ssb_bias.png'), width = 10, height = 4, dpi = 300)

bias_ts_plot(totbiom_bias_df, 'Total Biomass Bias')
ggsave(file.path(fig_dir, 'totbiom_bias.png'), width = 10, height = 4, dpi = 300)

bias_ts_plot(rec_bias_df, 'Recruitment Bias')
ggsave(file.path(fig_dir, 'rec_bias.png'), width = 10, height = 4, dpi = 300)
...
ggplot(scalar_bias_df, aes(x = cl_yr, y = median)) +
  ...
  theme_bw(base_size = 13)
ggsave(file.path(fig_dir, 'scalar_bias.png'), width = 10, height = 6, dpi = 300)
...
anim_save(file.path(fig_dir, 'all_tracking.gif'))
