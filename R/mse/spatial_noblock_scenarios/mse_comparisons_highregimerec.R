...
ggplot() +
  ...
  theme_bw(base_size = 13)
ggsave(file.path(fig_dir, 'ssb_regional_highregimerec.png'), width = 14, height = 4, dpi = 300)
...
ggplot() +
  ...
  theme_bw(base_size = 13)
ggsave(file.path(fig_dir, 'catch_regional_highregimerec.png'), width = 14, height = 4, dpi = 300)
...
ggplot() +
  ...
  theme_bw(base_size = 13)
ggsave(file.path(fig_dir, 'rec_regional_highregimerec.png'), width = 14, height = 4, dpi = 300)
...
ggplot() +
  ...
  theme_bw(base_size = 13)
ggsave(file.path(fig_dir, 'apportionment_highregimerec.png'), width = 14, height = 4, dpi = 300)
