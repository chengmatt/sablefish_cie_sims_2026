...
for(i in 1:3) { # no time block
  ...
  saveRDS(sim_env_current, here("outputs", "mse_results", "spatial_noblock_scenarios", paste("faa_lowregimerec", "_", i, ".RDS", sep = "")))
...
for(i in 1:3) {
  ...
  saveRDS(sim_env_current, here("outputs", "mse_results", "spatial_noblock_scenarios", paste("faa_lowregimerec_tb", "_", i, ".RDS", sep = "")))
