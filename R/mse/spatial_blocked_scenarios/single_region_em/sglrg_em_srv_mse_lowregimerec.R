...
saveRDS(sim_env_current, here("outputs", "mse_results","spatial_blocked_scenarios",  "single_region_lowregime_current.RDS"))
...
saveRDS(sim_env_hist, here("outputs", "mse_results", "spatial_blocked_scenarios", "single_region_lowregime_hist.RDS"))
...
saveRDS(sim_env_all, here("outputs", "mse_results", "spatial_blocked_scenarios", "single_region_lowregime_all.RDS"))
