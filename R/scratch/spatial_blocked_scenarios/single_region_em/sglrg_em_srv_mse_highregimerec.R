# Purpose: To run a five region OM, with a single region EM (regime recruitment)
...
sim_list_regime <- condition_closed_loop_simulations(
...
sim_env_current <- Setup_sim_env(sim_list = sim_list_regime)
...
saveRDS(sim_env_current, here("outputs", "mse_results", "spatial_blocked_scenarios",  "single_region_highregime_current.RDS"))

# Single-region, historical design
sim_env_hist <- Setup_sim_env(sim_list = sim_list_regime)
...
saveRDS(sim_env_hist, here("outputs", "mse_results","spatial_blocked_scenarios",  "single_region_highregime_hist.RDS"))

# Single-region, sample all regions
sim_env_all <- Setup_sim_env(sim_list = sim_list_regime)
...
saveRDS(sim_env_all, here("outputs", "mse_results","spatial_blocked_scenarios",  "single_region_highregime_all.RDS"))
